    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100 dark:bg-gray-900">
        <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-6">
                ...
                <div class="mt-8">
                    <button type="submit" class="w-full !bg-gray-600 hover:!bg-gray-700 !text-white font-bold py-3 px-4 rounded-lg text-lg shadow-lg transition duration-200 ease-in-out transform hover:scale-105" style="background-color: #4B5563 !important; color: white !important;">
                        {{ __('Create Account') }}
                    </button>
                </div>
                ...
                <div class="text-center mt-4">
                    <a class="text-blue-600 hover:text-blue-800 underline text-sm" href="{{ route('login') }}">
